...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await idk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await idk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await idk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await adk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await adk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await adk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await edk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await edk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await edk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sid(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sid(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await sid(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shy(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shy(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shy(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await aan(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await aan(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await aan(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ake(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ake(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await ake(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await eel(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await eel(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await eel(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await khu(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await khu(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await khu(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shi(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shi(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await shi(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await dav(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await dav(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await dav(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await raj(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await raj(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await raj(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await put(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await put(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            await put(functions.channels.JoinChannelRequest(channel=" @RoyalFriendsforever"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit("𝐆𝐇𝐔𝐒 𝐆𝐘𝐀 𝐇𝐔 𝐕𝐀𝐈 , 𝐀𝐁𝐁 𝐎𝐑𝐃𝐄𝐑 𝐃𝐎 𝐁𝐒𝐒")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("𝐖𝐎𝐖, 𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐆𝐑𝐎𝐔𝐏 𝐆𝐇𝐔𝐒 𝐆𝐘𝐀 𝐇𝐔")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "𝐈𝐒𝐊𝐎 𝐌𝐀𝐈 𝐏𝐄𝐋 𝐃𝐔𝐍𝐆𝐀 𝐕𝐀𝐈 , 𝐀𝐀𝐏 𝐀𝐑𝐀𝐀𝐌 𝐊𝐑𝐎"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = "JAA BETA TEREKO MAAF KIYA HNY NE"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
            ...
            try:
                ...
                pass
            text = "𝐕𝐀𝐈 𝐀𝐀𝐏𝐊𝐄 𝐊𝐄𝐇𝐍𝐄 𝐏𝐄 𝐂𝐇𝐇𝐎𝐃 𝐃𝐈𝐀 𝐈𝐒𝐊𝐎"
            await e.reply(text, parse_mode=None, link_preview=None )
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"𝐙𝐈𝐍𝐃𝐀 𝐇𝐔 𝐉𝐀𝐀𝐍\n`{ms}` 𝗺𝘀\n𝐁𝐒𝐒 𝐎𝐑𝐃𝐄𝐑 𝐃𝐄 𝐓𝐔")
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = "𝐖𝐀𝐈𝐓 𝐕𝐀𝐈 , 𝐌𝐀𝐈 𝐀𝐀𝐓𝐀 𝟐 𝐌𝐈𝐍 𝐌𝐄"
        await e.reply(text, parse_mode=None, link_preview=None )
        try:
...
async def help(e):
    if e.sender_id in SMEX_USERS:
       text = " HNY S SPAM \n\nCOMMANDS:\n.ping\n.restart\n\nUSERBOT COMMANDS:\n.bio\n.join\n.pjoin\n.leave\n\nSPAM COMMANDS:\n.spam\n.delayspam\n.bigspam\n.raid\n.replyraid\n.dreplyraid\n\n\nFOR MORE INFO - @RoyalFriendsforever"
       await e.reply(text, parse_mode=None, link_preview=None )
...
text = """
CONGRATS🥳🥳🥳 YOUR FASTEST, SMOOTHEST AND POWERFUL HNY X SPAMBOTS DEPLOYED SUCCESSFULLY """

print(text)
print("")
print("HNY X SPAMBOTS DEPLOYED!!")
